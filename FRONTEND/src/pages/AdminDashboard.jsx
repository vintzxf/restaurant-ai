...
export default function AdminDashboard() {
  ...
  async function fetchApplications() {
    setLoading(true);
    try {
      const res = await fetch(`https://counterai-backend.onrender.com/api/vendor/applications`, {
  ...
  async function fetchUsers() {
    setLoading(true);
    try {
      const res = await fetch(`https://counterai-backend.onrender.com/api/admin/users`, {
        headers: { "x-user-id": user._id },
      });
      const data = await res.json();
      setUsers(data);
  ...
  async function handleDecision(vendorId, decision) {
    try {
      const res = await fetch(`https://counterai-backend.onrender.com/api/vendor/${decision}/${vendorId}`, {
        method: "PATCH",
        headers: { "x-user-id": user._id },
      });
      const data = await res.json();
